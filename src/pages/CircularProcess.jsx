...
const CircularProcess = () => {
  return (
    <>
      ...
      >
        <p>
          After more than seven decades supplying recycled yarns to the fashion
          industry, circularity is in our DNA. Recycled raw material, zero
          chemicals, zero water and minimal CO2 emissions. Circular business
