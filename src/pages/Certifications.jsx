      ...
      <main className="certifications">
        ...
        <div className="certifications-items">
          <CertificationItem title="Standard 100 of OEKO-TEX®" img={certOeko}>
            <p>
              Ferre is OEKO-TEX® STANDARD 100 certified. It is one of the
              world’s best-known labels for textiles tested for harmful
              substances. Represents customer trust and high product safety. The
              test is performed by independent OEKO-TEX® partner institutes and
              numerous regulated and unregulated substances are taken into
              account, which can be harmful to human health. In many cases, the
              limit values of the STANDARD 100 go beyond national and
          ...
          <CertificationItem title="LCA" img={certLca}>
            <p>
              ...
              This assessment of the environmental impact of our products has
              been third-party reviewed by AITEX, Universitat de València and
              UNESCO, to ensure transparency.
            </p>
          </CertificationItem>
        </div>
        <div className="certifications-title">
        ...
        <div className="associations-items">
          <CertificationItem title="UN Global Compact" img={certReduzco}>
            <p>
              ...
              initiative to encourage businesses worldwide to align strategies
          ...
          <CertificationItem title="Textile Exchange" img={certCompact}>
            <p>
              ...
              global textile industry and maximizing its positive effects, as
              well as helping to establish good practices and fair business
              models throughout the supply chain.
            </p>
          </CertificationItem>
