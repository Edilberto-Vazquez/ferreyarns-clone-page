    ...
    <div className="legal-notice some-questions-section-item">
      <SectionItem title="1. GENERAL ASPECTS LEGAL NOTICE">
        <SectionItem title="1.1. Identification data of the Information Society Service Provider">
          <p>
            In compliance with Article 10 of Law 34/2002, of July 11, on
            Information Society Services and Electronic Commerce. This portal is
            owned by: Hilaturas Ferre SA tax I.D number: A-03008836
          </p>
          <p>
            <strong>Address: </strong>Avda. Les Molines, 2
          </p>
          <p>(03450) BANYERES DE MARIOLA (Alicante – Spain)</p>
          <p>
            <strong>Telephone: </strong> +34 966 567 425
          </p>
          <p>
            <strong>Internet: </strong>http://www.ferreyarns.com
          </p>
          <p>
            <strong>E-mail: </strong>info@ferreyarns.com
          </p>
        </SectionItem>
        <SectionItem title="1.2. Acceptance and validity of the general and particular conditions">
          <p>
            Both the navigation and the use and/or order of any of the products
          ...
          <p>
            The Company reserves the right to expand and modify unilaterally, at
      ...
      <SectionItem title="2. GENERAL CONDITIONS OF USE FOR THE WEBSITE">
        <SectionItem title="2.1. Obligations of use">
          <p>
            As a general rule, the User is legally bound to the use terms and
          ...
          <p>
            As a particular rule that does not imply any kind of restriction on
            the general rule contracted by the User in the previous paragraph,
            during the use of this Website the user is bound to:
          </p>
          <SectionItemList listType="ul" listItems={obligationsUse} />
          <p>
            The Company may, at any time and without prior notice, modify these
        ...
        <SectionItem title="2.2. Exemption of liability">
          <p>
            The Company does not give any guarantees and is in no case
            responsible for damages of any nature that may result in:
          </p>
        </SectionItem>
        <SectionItemList listType="ul" listItems={exemptionLiability} />
        <SectionItem title="2.3. Use of hyperlinks">
          <p>
            The Internet user who wants to introduce links from their own
          ...
          <p>
            The link only linked to the home page or main page of the Portal,
          ...
          <p>
            The web page inserting the link shall not contain any kind of false,
          ...
          <p>
            Under no circumstances shall the page containing the link state that
          ...
          <p>
            The use of any denominative, graphic or mixed brand or of another
          ...
          <p>
            The page you establish the link must comply faithfully with the law
        ...
        <SectionItem title="2.4. Intellectual Property">
          <p>
            The structure, design, and presentation of the elements available on
          ...
          <p>
            The use of distinctive signs (trademarks, trade names) is not
            allowed, unless expressly authorized by the legitimate owners.
          </p>
          <p>
            Unless expressly authorized by Hilaturas Ferre, the link to “final
        ...
        <SectionItem title="2.5. Jurisdiction and applicable law">
          <p>
            These General Conditions are subject to Spanish legislation and
            jurisdiction.
          </p>
          <p>
            The Company and the User, regardless of their address, expressly
